<?php
	...
	class User extends CROOD {
		...
		function init($args = false) {
			...
			$this->table = 'user';
			$this->table_fields = array('id', 'login', 'email', 'password', 'nicename', 'status', 'type', 'created', 'modified');
			$this->update_fields = array('login', 'email', 'password', 'nicename', 'status', 'type', 'modified');
			...
			if (! $this->id ) {
				...
				//Fetch metas
				if ( $args && in_array('fetch_metas', $args) ) {
	...
	class Users extends NORM {
		...
		protected static $table_fields = array('id', 'login', 'email', 'password', 'nicename', 'status', 'type', 'created', 'modified');
